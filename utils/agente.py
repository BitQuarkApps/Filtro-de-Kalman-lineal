...
class Jugador(pygame.sprite.Sprite):
	...
	def predecir_movimiento(self, sigma_p, sigma_v, F, Xt):
		...
		# Dibujar un vector con el angulo de inclinacion
		startpoint = pygame.math.Vector2(X2, Y2)
		endpoint = pygame.math.Vector2(X1, Y1)
		current_endpoint = startpoint + endpoint.rotate(angulo_inclinacion)
		pygame.draw.line(self.image, RED, startpoint, current_endpoint, 5)
		...
		filtradaX = self.Xt_t[0][0]
		filtradaY = self.Xt_t[1][0]
		predichaX = self.Xt_t_menos_1[0][0]
		predichaY = self.Xt_t_menos_1[1][0]
		self.Xt_t_menos_1 = self.Xt_t
		return filtradaX, filtradaY, predichaX, predichaY
